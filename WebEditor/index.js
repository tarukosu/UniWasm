...
class Vector3Component extends Rete.Component {
  ...
  builder(node) {
      ...
      var out1 = new Rete.Output('output_x', "x", numSocket);
      return node.addInput(inp1).addOutput(out1);
  }

  worker(node, inputs, outputs) {
      outputs['output_x'] = inputs['input'][0];
  }
}
...
(async () => {
    ...
    var components = [new NumComponent(), new AddComponent(), new GetPositionComponent(), new DeconstructVector3Component()];
